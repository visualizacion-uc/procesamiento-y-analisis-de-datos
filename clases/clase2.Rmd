...
Vamos a usar el archivo [clase2_vuelos.zip](https://visualizacion-uc.github.io/procesamiento-y-analisis-de-datos/datasets/clase2_vuelos.zip) y lo vamos a descargar al directorio "datasets" y leer desde R.
...
if(!file.exists(zip)) {
  download.file(
    "https://visualizacion-uc.github.io/procesamiento-y-analisis-de-datos/datasets/clase2_vuelos.zip",
    zip)
}
