...
Creen tablas que contengan:

1. Cada superhéroe con el año en que se fundó su editorial.
2. Las observaciones de `superheroes` tales que la dimensión `publisher` aparece en la tabla `publishers`. ¿Qué ocurre con Hellboy?
3. Las observaciones de `superheroes` tales que la dimensión `publisher` no aparece en la tabla `publishers`. ¿Qué ocurre con Hellboy?
4. Las observaciones sin duplicados de `publishers` tales que la dimensión `publisher` aparece en la tabla `superheroes`.
5. Todos los elementos de `superheroes` y `publishers`.
