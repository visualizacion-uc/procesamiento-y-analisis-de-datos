...
Vamos a usar el archivo [lecture1_officesupplies.xlsx](https://visualizacion-uc.github.io/procesamiento-y-analisis-de-datos/datasets/clase1_insumosoficina.xlsx) y lo vamos a descargar y leer desde R.
...
if(!file.exists(file)) {
  download.file(
    "https://visualizacion-uc.github.io/procesamiento-y-analisis-de-datos/datasets/clase1_insumosoficina.xlsx",
    file)
}
```
...
Vamos a usar el archivo [lecture1_copper.csv](https://visualizacion-uc.github.io/procesamiento-y-analisis-de-datos/datasets/clase1_cobre.csv) y lo vamos a descargar y leer desde R.
...
if(!file.exists(file)) {
  download.file(
    "https://visualizacion-uc.github.io/procesamiento-y-analisis-de-datos/datasets/clase1_cobre.csv",
    file)
}
```
